...
def create_and_solve_model(school, processed_data_folder, deviation, min_prefs_per_student):
    # Read data
...
def run_milp():
    ...
    create_and_solve_model(school, processed_data_folder, deviation, min_prefs_per_student)
